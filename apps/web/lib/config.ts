...
export function getChains(): ChainConfig[] {
  return [
    ...
    },
    {
      ...
      pyusdAddress: (process.env.NEXT_PUBLIC_PYUSD_SEPOLIA || '0xa45Ec65FaDB8AE3b61b330906123644f1aef544c') as Address,
      ...
      contracts: {
        merchantRegistry: (process.env.NEXT_PUBLIC_REGISTRY_SEPOLIA || '0xf1b0ec37bC5455F210cd1d85582fb6e6a28E0903') as Address,
        invoice: (process.env.NEXT_PUBLIC_INVOICE_SEPOLIA || '0x84E7E889E1352A3b692C23e7cfEc0430a1b0a4cE') as Address,
        checkout: (process.env.NEXT_PUBLIC_CHECKOUT_SEPOLIA || '0x1E08F7089D6c7BCCd6e1bedd2a77E3D8C35bd66F') as Address,
        paymaster: (process.env.NEXT_PUBLIC_PAYMASTER_SEPOLIA || '0x115F7e5F5A3bcC297718c5805cC0a08Fa9b9c735') as Address,
        bridgeEscrow: (process.env.NEXT_PUBLIC_BRIDGE_ESCROW_SEPOLIA || '0x84cf99d51b54A6251Ba8A0A3A0F725c7e1009d0B') as Address,
        accountFactory: (process.env.NEXT_PUBLIC_ACCOUNT_FACTORY_SEPOLIA || '0x3d5ccfCBB97607F62F7Ee3B823ba8cF78C999E4b') as Address,
      },
    },
  ];
}
